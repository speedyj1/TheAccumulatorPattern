...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(0, 3, 0)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 4
    answer = count_cosines_from(5, 9, -.9)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(6, 7, 0.29)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.845634  # This is APPROXIMATELY the correct answer.
